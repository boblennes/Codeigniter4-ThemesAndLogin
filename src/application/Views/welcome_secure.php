		...
		<div class="wrap">
			...
			<div class="guide">
				<p>This page represents a <i class='fa fa-lock'></i> SECURE page and is being generated dynamically by CodeIgniter.</p>

				<p>If you would like to edit this page you'll find it located at:</p>

				<pre>
				<code>
					application/Views/welcome_secure.php
				</code>
				</pre>
				...
				<pre>
				<code>
					application/Controllers/Secure.php
				</code>
				</pre>
